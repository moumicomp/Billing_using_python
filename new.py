...
class Customer:
    ...
    def __init__(self,root):
        ...
        self.root.config(background="turquoise")

        ABC=Frame(self.root,bg="turquoise",bd=15,relief=RIDGE)
        ABC.grid()
        ABC1=Frame(ABC,bd=5, height=100,width=1330,padx=10,bg="turquoise",relief=RIDGE)
        ...
        ABC7=Frame(ABC5,bd=5, height=100,width=290,padx=10,bg="aquamarine",relief=RIDGE)
        ...
        self.lblTitle=Label(ABC1, textvariable=Date1, font=('Arial',31),pady=9,bd=15,bg='turquoise'
                            , fg='black').grid(row=0,column=0)
        self.lblTitle=Label(ABC1, text='CUSTOMER BILLING SYSTEM', font=('cooper black',44),pady=15,bd=15
                            ,bg='turquoise'
                            , fg='black').grid(row=0,column=1)
        self.lblTitle=Label(ABC1, textvariable=Time1, font=('Arial',31),pady=9,bd=15,bg='turquoise'
        ...
        self.txtReceipt= Text(ABC6, height=27, width=45,bd=10,font=('arial',9,'bold') )
        ...
        Customer_ref.set(random.randint(19800,987654))
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.lblDate=Label(ABC2, textvariable=Date, font=('Arial',12,'bold'),padx=2,bd=2,bg='white',width=12
        ...
        self.milks=Checkbutton(ABC4,text='Milk_shake',variable=var17,onvalue=1,offvalue=0,font=('Arial',8,'bold'),
        ...
        def costOfItem():
             ...
             self.txtReceipt.insert(END,'Customer_ref:\t\t'+Customer_ref.get()+"\n")

             self.txtReceipt.insert(END,'Items\t\t\t'+"Cost Of Items\n")
            
             
             self.txtReceipt.insert(END,'Chicken Cutlet:\t\t\t'+E_chick.get()+"\n")
             self.txtReceipt.insert(END,'Veg. Sandwich:\t\t\t'+E_vsand.get()+"\n")
             self.txtReceipt.insert(END,'Chicken Sandwich:\t\t\t'+E_chicksa.get()+"\n")
             self.txtReceipt.insert(END,'Chick Cheese Balls:\t\t\t'+E_chickcb.get()+"\n")
             ...
             self.txtReceipt.insert(END,'ChocoBrownie:\t\t\t'+E_chocob.get()+"\n")
        ...
        self.btnExit= Button(ABC7, padx=2, pady=2, bd=7, fg='black', font=('arial',16,'bold'), width=7, height=2,
